...
library.theme.topheight = 38

game:GetService("UserInputService").OverrideMouseIconBehavior = Enum.OverrideMouseIconBehavior.None
game:GetService("UserInputService").MouseIconEnabled = true

-- Smaller height for less empty space
local Window = library:CreateWindow("SHOP by @boo10001", Vector2.new(380, 420), Enum.KeyCode.RightShift)
...
local function createRestoreCircle()
    ...
    circle.InputEnded:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            -- If it was a quick click (not a drag), show the GUI
...
print("SHOP by @boo10001 - Fixed circle + smaller height")
